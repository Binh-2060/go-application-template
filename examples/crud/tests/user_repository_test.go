...
statement. Absence has to be read off the command tag instead, and this is the
test that fails if someone rewrites the check to rely on the error.
*/
func TestDeleteUser_MissingRowReturnsErrUserNotFound(t *testing.T) {
...
func TestListUsers_FilterIsCaseInsensitiveSubstring(t *testing.T) {
	...
	users, err := repositories.ListUsers(ctx, repositories.UserFilter{Name: strings.ToUpper(m + "ada")}, 10, 0)
	if err != nil {
...
func TestListUsers_InjectionShapedFilterMatchesNothing(t *testing.T) {
	...
	users, err := repositories.ListUsers(ctx, repositories.UserFilter{Name: m + "' OR '1'='1"}, 10, 0)
	if err != nil {
		t.Fatalf("repositories.ListUsers: %v", err)
	}
...
func TestListUsers_NoMatchesReturnsEmptyNotNil(t *testing.T) {
	users, err := repositories.ListUsers(context.Background(), repositories.UserFilter{Name: marker(t)}, 10, 0)
	if err != nil {
		t.Fatalf("repositories.ListUsers: %v", err)
	}
...
func TestListUsers_PagesDoNotOverlap(t *testing.T) {
	...
	filter := repositories.UserFilter{Name: m}
...
func TestCountUsers_HonoursTheSameFilter(t *testing.T) {
	...
	total, err := repositories.CountUsers(ctx, repositories.UserFilter{Name: m})
	if err != nil {
